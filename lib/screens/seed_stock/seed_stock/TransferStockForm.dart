...
class TransferStockForm extends StatefulWidget {
  @override
  State<TransferStockForm> createState() => TransferStockFormState();
}

late CustomTheme customTheme;

class TransferStockFormState extends State<TransferStockForm> {
  ...
  List<StockModel> importPermit = [];

  Future<bool> init_form() async {
    return true;
    // importPermit = await StockModel.get_items();
...
*/
    ...
    f["crop_variety_id"] = _fKey.currentState?.fields['crop_variety_id']?.value;
    f["quantity"] = _fKey.currentState?.fields['quantity']?.value;
    f["seed_class"] = _fKey.currentState?.fields['seed_class']?.value;
    f["is_transfer"] =
        (_fKey.currentState?.fields['is_transfer']?.value == "Stock transfer")
            ? 1
            : 0;
                                        ...
                                        Container(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              SizedBox(height: 10),
                                              FxText(
                                                'Select Receiver, if you are transferring stock',
                                              ...
                                              SizedBox(height: 10),
                                              FxText(
                                                'Add details, if you are not transferring stock',
                                                textAlign: TextAlign.start,
                                              ),
                                              SizedBox(height: 10),
                                              FormBuilderTextField(
