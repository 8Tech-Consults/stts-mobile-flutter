...
class CropInspection extends StatefulWidget {
  ...
  const CropInspection(
      {super.key, required this.inspection, required this.isCrop});
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          FormBuilderTextField(
                                            ...
                                            initialValue: widget.inspection.form
                                                ?.cropVariety?.name,
                                            name: "variety",
                                            textInputAction:
                                                TextInputAction.next,
                            ...
                            onPressed: () {
                              if (!_fKey.currentState!.validate()) {
                                ...
                                addInspection.diseases = _fKey
                                    .currentState?.fields['diseases']?.value;
                                ...
                                addInspection.furtherRemaks = _fKey.currentState
                                    ?.fields['further_remaks']?.value;
                                ...
                                addInspection.offTypes = _fKey
                                    .currentState?.fields['off_types']?.value;
                                ...
                                model.submitCropInspection(addInspection,
                                    widget.inspection.form?.id, widget.isCrop);
