...
class ExportPermitForm extends StatefulWidget {
  const ExportPermitForm({super.key});

  @override
  State<ExportPermitForm> createState() => ExportPermitFormState();
}

late CustomTheme customTheme;

class ExportPermitFormState extends State<ExportPermitForm> {
  AddQualityAssuranceForm addExportPermit = AddQualityAssuranceForm();
                            ...
                            onPressed: () {
                              if (isCropVariety) {
                                ...
                                if (!_fKey.currentState!.validate()) {
                                  ...
                                  addExportPermit.telephone = _fKey
                                      .currentState?.fields['telephone']?.value;
                                  addExportPermit.address = _fKey
                                      .currentState?.fields['address']?.value;
                                  addExportPermit.storeLocation = _fKey
                                      .currentState
                                      ?.fields['store_location']
                                      ?.value;
                                  addExportPermit.quantiryOfSeed = _fKey
                                      .currentState
                                      ?.fields['quantiry_of_seed']
                                      ?.value;
                                  addExportPermit.supplierName = _fKey
                                      .currentState
                                      ?.fields['supplier_name']
                                      ?.value;
                                  addExportPermit.name =
                                      _fKey.currentState?.fields['name']?.value;
                                  addExportPermit.supplierAddress = _fKey
                                      .currentState
                                      ?.fields['supplier_address']
                                      ?.value;
                                  addExportPermit.nameAddressOfOrigin = _fKey
                                      .currentState
                                      ?.fields['name_address_of_origin']
                                      ?.value;
                                  addExportPermit.istaCertificate = (_fKey
                                      .currentState
                                      ?.fields['ista_certificate']
                                      ?.value);
                                  addExportPermit.type =
                                      _fKey.currentState?.fields['type']?.value;
                                  addExportPermit.isImport = false;
                                  addExportPermit.administratorId =
                                      locator<UserController>().user?.id;
                                  addExportPermit.cropVarieties =
                                      selectedVarieties;
                                  model.submitExportPermitForm(addExportPermit);
